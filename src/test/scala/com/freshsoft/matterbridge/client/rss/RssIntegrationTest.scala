...
import com.freshsoft.matterbridge.entity.MatterBridgeEntities.{RssFeedConfigEntry, RssReaderActorModel, RssReaderIncomingModel, RssReaderModel}
...
class RssIntegrationTest extends TestKit(ActorSystem("testSystem")) with WordSpecLike with Matchers  {
	...
	val testRssConfigEntry = RssFeedConfigEntry("http://www.fbrssfeed.com/feed/5L2C8G7eoF1ihHlKpwuzvWgXPI40VdtNAyqmkjan", "token", "name")
