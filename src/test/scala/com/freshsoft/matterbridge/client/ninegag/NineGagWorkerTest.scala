...
class NineGagWorkerTest
  ...
  val receiver: ActorRef = system.actorOf(Props(classOf[NineGagIntegration.NineGagGifReceiver]))

  val nineGagWorker: ActorRef = system.actorOf(Props(classOf[NineGagWorker], receiver))
